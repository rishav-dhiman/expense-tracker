                ...
                <div className="w-full lg:min-w-[320px] lg:max-w-[350px]">
                    ...
                    <form onSubmit={handleAdd} noValidate className="flex flex-col gap-5">
                        <div className="flex flex-col gap-1">
                            <input type="text" placeholder="Investment Title" required value={formData.title} onChange={e => setFormData({...formData, title: e.target.value})} className={`${inputClasses} ${fieldErrors.title ? 'border-red-500' : ''}`} />
